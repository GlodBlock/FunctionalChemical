...
public class FCRecipeProvider extends TitaniumRecipeProvider {
    ...
    public void register(Consumer<FinishedRecipe> c) {
        ...
        TitaniumShapedRecipeBuilder.shapedRecipe(FCItemAndBlock.DECAY_UPGRADE)
                .pattern("EEE")
                .pattern("BDB")
                .pattern("EEE")
                ...
                .save(c);
        TitaniumShapedRecipeBuilder.shapedRecipe(FCItemAndBlock.ADV_DECAY_UPGRADE)
                .pattern("DDD")
                .pattern("DXD")
                .pattern("DDD")
                .define('X', MekanismTags.Items.STORAGE_BLOCKS_REFINED_GLOWSTONE)
                .define('D', FCItemAndBlock.DECAY_UPGRADE)
                .save(c);
    }
