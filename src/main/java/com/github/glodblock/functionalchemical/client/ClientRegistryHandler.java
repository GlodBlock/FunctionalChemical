...
public class ClientRegistryHandler {
    ...
    public void registerClientItemExt(RegisterClientExtensionsEvent event) {
        event.registerItem(ChemDrawerItemRender.EXT1, FCSingletons.CHEM_DRAWER_1.asItem(), FCSingletons.RADIOACTIVE_DRAWER.asItem());
        event.registerItem(ChemDrawerItemRender.EXT2, FCSingletons.CHEM_DRAWER_2.asItem());
        event.registerItem(ChemDrawerItemRender.EXT4, FCSingletons.CHEM_DRAWER_4.asItem());
    }
